...
from ahdms.app_identity_audit import AppIdentityAudit
import time
...
#应用标识审核
driver.get("https://ra.teikiaid.org/login/index.html")
pin = "12345678"
AppIdentityAudit(driver, pin).app_identity_audit(random, random)
